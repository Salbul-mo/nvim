...
return {
    {
        ...
        config = function()
            ...
            dap.configurations.python = {
                {
                    ...
                    program = "${file}",
                    pythonPath = function()
                        -- Use active virtual environment if available
            ...
            dap.adapters.java = function(callback)
                -- Assume the Debug Adapter is already started by jdtls
        ...
        config = function()
            require("mason-nvim-dap").setup({
                ensure_installed = {
                    ...
                    "javadbg", -- For Java debugging
                    "javatest", -- For Java testing
                },
                ...
                handlers = {
                    ...
                    delve = function(config)
                        table.insert(config.configurations, 1, { args = function()
                    return vim.split(vim.fn.input("args> "), " ") end,
                    type = "delve",
                    name = "file",
                    request = "launch",
                    program = "${file}",
